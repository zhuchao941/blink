...
@MapperScan(basePackages = { "com.dianwoba.redcliff.blink.mapper" }, sqlSessionFactoryRef = "aSqlSessionFactory")
public class MybatisConfig {

	private static Log log = LogFactory.getLog(MybatisConfig.class);

	@javax.annotation.Resource(name = "mybatis.CONFIGURATION_PROPERTIES")
